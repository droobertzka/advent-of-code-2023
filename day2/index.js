const isPossible = (actual, game) => game.sets.every(
	({red = 0, green = 0, blue = 0}) => red <= actual.red && green <= actual.green && blue <= actual.blue,
)
...
const findMinimums = game => game.sets.reduce((acc, {red = 0, green = 0, blue = 0}) => ({
